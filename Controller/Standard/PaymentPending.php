...
class PaymentPending extends WebhookAbstract
{
    public function execute()
    {
        try {
            ...
            $this->fintectureLogger->debug('Webhook Payment Pending Response Error 1 ' . $e->getMessage(), $e->getTrace());
        } catch (Exception $e) {
            $this->fintectureLogger->debug('Webhook Payment Pending Response Error 2 ' . $e->getMessage(), $e->getTrace());
        }
    }
}
